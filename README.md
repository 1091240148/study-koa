...
Visit http://127.0.0.1:3011 . You should see nothing but 'Not Found' in the page, since we haven't add any content.
...
Visit http://127.0.0.1:3011 . Now you should see 'Hello World' in the page.
...
Visit http://127.0.0.1:3011 . What you see depends on the `Accept` field of HTTP request header. In most cases, the content will be a XML document.
...
Visit http://127.0.0.1:3011 . You will see the content of the template file.
...
Visit http://127.0.0.1:3011/about . You could click the link to the Index page.
...
Visit http://127.0.0.1:3011 . You will see the logging info in console.
...
Visit http://127.0.0.1:3011 . You will see the following result in console.
...
Visit http://127.0.0.1:3011/12.js . you will see the above code.
...
Visit http://127.0.0.1:3011/redirect. The browser will be redirected to the root path.
...
visit http://127.0.0.1:3011. You will see a 500 error page of "Internal Server Error".
...
Visit http://127.0.0.1:3011 . You will see a 404 error page of 'Page Not Found'.
...
Visit http://127.0.0.1:3011 . You will see a 500 page of `{"message":"Internal Server Error"}`.
...
Visit http://127.0.0.1:3011 . You will see `server error` in the command line console.
...
Visit http://127.0.0.1:3011 . You will see `logging error ` in the command line console.
...
Visit http://127.0.0.1:3011 and refresh the page, and you should see `1 views` at first, then `2 views`.
...
```bash
$ curl -X POST --data "name=Jack" 127.0.0.1:3011
{"name":"Jack"}

$ curl -X POST --data "name" 127.0.0.1:3011
name required
```
...
```bash
$ curl --form upload=@/path/to/file http://127.0.0.1:3011
["/tmp/file"]
```
